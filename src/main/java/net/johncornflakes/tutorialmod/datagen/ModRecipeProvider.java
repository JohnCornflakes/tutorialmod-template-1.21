...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter recipeExporter) {
        List<ItemConvertible> PINK_GARNET_SMELTABLES = List.of(ModBlocks.PINK_GARNET_ORE, ModItems.RAW_PINK_GARNET,
...
//        offerReversibleCompactingRecipes(recipeExporter, RecipeCategory.BUILDING_BLOCKS, ModItems.RAW_PINK_GARNET, RecipeCategory.MISC, ModBlocks.RAW_PINK_GARNET_BLOCK);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.RAW_PINK_GARNET_BLOCK)
                ...
                .pattern("RRR")
                .pattern("RRR")
                .input('R', ModItems.RAW_PINK_GARNET) //R key is a char
        ...
        //identifier names new recipe

//        createDoorRecipe(ModBlocks.PINK_GARNET_DOOR, (Ingredient) ModItems.PINK_GARNET);
    }
