package net.johncornflakes.tutorialmod.block.custom;
...
public class MagicBlock extends Block {
    ...
    private boolean isValidItem(ItemStack stack) {
        ...
        //transformable items is defined in data/MOD_ID/tags/item/transformable_items.json
    }

    @Override
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType options) {
        tooltip.add(Text.translatable("tooltip.tutorialmod.magic_block.tooltip"));
        tooltip.add(Text.translatable("tooltip.tutorialmod.magic_block.tooltip1"));
